...
public class ByteBufferTest
{
    ...
    private static final int dd=1<<32;
    private static final AtomicInteger currentProcessor = new AtomicInteger(0);
    public static void main(String args[]) {
        ...
        */
        System.out.println(Math.max(31-199, 34));
        System.out.println(0xffffffff >>> 1);
        /*
        int size=1<<4;
        for (int i = 0; i <= 30; i++){
            System.out.println(currentProcessor.getAndIncrement() & (size - 1));
        }
    ...
    public static void allocateTest(){
        ...
        for(int i = 0; i < buffer.limit(); i++){
              System.out.println(buffer.put((byte)i));
        }
        System.out.println("【allocateTest】上限：" + buffer.limit() + " 容量：" + buffer.capacity() + " 位置：" + buffer.position());
    }
